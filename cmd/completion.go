...
Bash:
  ...
  # To persist: sshady completion bash > /etc/bash_completion.d/sshady

Zsh:
  source <(sshady completion zsh)
  # To persist: sshady completion zsh > "${fpath[1]}/_sshady"

Fish:
  sshady completion fish | source
  # To persist: sshady completion fish > ~/.config/fish/completions/sshady.fish
